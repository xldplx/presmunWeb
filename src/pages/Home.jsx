...
export default function Home() {
  ...
  const mediaPartners = [
    ...
    { id: 7, img: "/assets/medpart/JAKARTA_MUN_(Asset 5@3x).png", alt: "Jakarta MUN 2" },
    { id: 8, img: "/assets/medpart/JSF.jpg", alt: "JSF" },
    { id: 9, img: "/assets/medpart/light@4x.png", alt: "Light" },
    { id: 10, img: "/assets/medpart/Logo_IDNL.png", alt: "IDNL" },
    { id: 11, img: "/assets/medpart/LOGO_ITS_MUN_BLUE.png", alt: "ITS MUN" },
    { id: 12, img: "/assets/medpart/Logo_Mun_FH.PNG", alt: "Mun FH" },
    { id: 13, img: "/assets/medpart/Logo_SyahidMUN.png", alt: "SyahidMUN" },
    { id: 14, img: "/assets/medpart/mahasiswa_penggerak.png", alt: "Mahasiswa Penggerak" },
    { id: 15, img: "/assets/medpart/PMUNC.jpg", alt: "PMUNC" },
    { id: 16, img: "/assets/medpart/PublikCikarang_transparan.png", alt: "Publik Cikarang" },
    { id: 17, img: "/assets/medpart/SIPALINGHI.png", alt: "Sipalinghi" },
  ];
